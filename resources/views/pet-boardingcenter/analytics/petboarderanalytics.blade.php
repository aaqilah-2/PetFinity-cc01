...
<div id="booking-status" class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            @endforeach
            <!-- Add the pending appointments as a separate card -->
            {{-- <div class="col-md-3">
                <div class="status-card">
                    <div class="status-name">Pending</div>
                    <div class="status-count">Appointment Count: {{ $bookingStatusDistribution->where('status', 'pending')->first()->count ?? 0 }}</div>
                </div>
            </div> --}}
        </div>
    </div>
